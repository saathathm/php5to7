$(document).ready(function() {
    ...
    function printCurRow(index) {
        ...
        html += "<td>" + cur_items[index].business_phone + "</td>";
        html += "<td>" + cur_items[index].status + "</td>";
        html += "<td>" + cur_items[index].comments + "</td>";
        html += "<td>" + cur_items[index].constultant + "</td>";
    ...
    function update_row(){
        ...
        $(document).on( "click", ".btnDelete", function(e) {           
            e.preventDefault();
            $('#myModal').modal({
                remote: 'modal_data2.php?p=' + this.id+'&par_id='+this.name
            });
            $('#myModal').modal('show');
            rec_id = this.id;
            par_id = this.name;
        ...
        $(document).on( "click", ".btnEditPar", function(e) {                
            e.preventDefault();
            $('#myModal2').modal({
                remote: 'modal_manual_data2.php?p=' + this.id
            });
            $('#myModal2').modal('show');
            rec_id = this.id;
        ...
        $('#btnDelteYes').click(function () {
            $.ajax({
                ...
                type: "POST",
                url: "save_modal_data2.php?a=save",
        ...
        $('#btnParEditYes').click(function () {
            $.ajax({
                ...
                type: "POST",
                url: "save_modal_manual_data2.php?a=save",
    ...
    function printSimilarRecords(index) {
        ...
        $.post("manual_check_data2.php", {
            ...
            for (var i = 0; i < dataset[0].TotalRows; i++) {
                ...
                html += "<td>" +record.business_phone + "</td>";
                html += "<td>" + record.status + "</td>";
                html += "<td>" + record.comments + "</td>";
                html += "<td>" + record.constultant + "</td>";
