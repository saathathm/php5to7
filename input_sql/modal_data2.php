    ...
    <div class="row">
        <div class="span4">
            <table class="table">
                ...
                <tr><th>Mobile Phone</th><td><input type="search" name="mobile" value="<?php echo $ind_value['mobile']; ?>"></td></tr>
...
else{echo '<div class="alert alert-error" style="display: ">Access Denied</div>';} ?>
