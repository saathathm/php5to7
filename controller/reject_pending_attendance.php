...
$emp_name=$_SESSION['name']; 
 // header("location:../view/paginator1.php?page=".$page."&&ipp=".$ipp);
...
if($_SESSION['emp_id']==$emp_id_in){
   header("location:../view/working_hours.php?f=1");  }
    ...
    $obj=new attendance();
$result=$obj->rejectPendingAttendance($id,$emp_name);
if($result){
    if($action=="individual"){header("location:../view/view_attendance_backup.php?employee_id=".$employee_id."&&date4=".$date);}
    else{header("location:../view/working_hours.php");}
}
else{
}
}}
